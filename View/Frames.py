...
class Frame(QtGui.QWidget):
    ...
    def _initUI(self):
        ...
        self._minibuffer.gorg_key_press_signal.connect(self._gorg_key_press)
        self._minibuffer.gorg_key_release_signal.connect(self._gorg_key_release)
    ...
    def _gorg_key_press(self, typ, key, wdg):
        self.gorg_key_press_signal.emit(typ, key, wdg)

    def _gorg_key_release(self, typ, key, wdg):
        self.gorg_key_release_signal.emit(typ, key, wdg)
